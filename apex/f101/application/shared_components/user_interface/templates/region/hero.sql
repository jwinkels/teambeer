...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2075362955107719)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2075644361107719)
,p_plug_template_id=>wwv_flow_imp.id(2075362955107719)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2075955817107719)
,p_plug_template_id=>wwv_flow_imp.id(2075362955107719)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2076239589107719)
,p_plug_template_id=>wwv_flow_imp.id(2075362955107719)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2076512495107719)
,p_plug_template_id=>wwv_flow_imp.id(2075362955107719)
,p_name=>'Sub Regions'
