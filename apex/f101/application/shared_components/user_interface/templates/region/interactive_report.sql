...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2098523327107725)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2098837385107725)
,p_plug_template_id=>wwv_flow_imp.id(2098523327107725)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2099110577107725)
,p_plug_template_id=>wwv_flow_imp.id(2098523327107725)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2099411259107726)
,p_plug_template_id=>wwv_flow_imp.id(2098523327107725)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2099793115107726)
,p_plug_template_id=>wwv_flow_imp.id(2098523327107725)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2100016824107726)
,p_plug_template_id=>wwv_flow_imp.id(2098523327107725)
,p_name=>'Sub Regions'
