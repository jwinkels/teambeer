...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2078582854107720)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2078894756107721)
,p_plug_template_id=>wwv_flow_imp.id(2078582854107720)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2079159353107721)
,p_plug_template_id=>wwv_flow_imp.id(2078582854107720)
,p_name=>'Sub Regions'
