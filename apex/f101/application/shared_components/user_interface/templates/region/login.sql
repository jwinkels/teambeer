...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2100696802107726)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2100938124107726)
,p_plug_template_id=>wwv_flow_imp.id(2100696802107726)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2101235067107726)
,p_plug_template_id=>wwv_flow_imp.id(2100696802107726)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2101575441107726)
,p_plug_template_id=>wwv_flow_imp.id(2100696802107726)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2101820158107726)
,p_plug_template_id=>wwv_flow_imp.id(2100696802107726)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2102159020107726)
,p_plug_template_id=>wwv_flow_imp.id(2100696802107726)
,p_name=>'Sub Regions'
