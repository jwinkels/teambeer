...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2120301322107730)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2120687747107730)
,p_plug_template_id=>wwv_flow_imp.id(2120301322107730)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2120924941107731)
,p_plug_template_id=>wwv_flow_imp.id(2120301322107730)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2121236220107731)
,p_plug_template_id=>wwv_flow_imp.id(2120301322107730)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2121535250107731)
,p_plug_template_id=>wwv_flow_imp.id(2120301322107730)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2121842666107731)
,p_plug_template_id=>wwv_flow_imp.id(2120301322107730)
