...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2049852129107709)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2050114830107709)
,p_plug_template_id=>wwv_flow_imp.id(2049852129107709)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2050472945107709)
,p_plug_template_id=>wwv_flow_imp.id(2049852129107709)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2050700116107709)
,p_plug_template_id=>wwv_flow_imp.id(2049852129107709)
,p_name=>'Sub Regions'
