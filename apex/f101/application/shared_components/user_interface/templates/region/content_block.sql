...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2071129869107718)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2071415494107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2071771615107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072036922107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072348883107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072641734107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2072982017107718)
,p_plug_template_id=>wwv_flow_imp.id(2071129869107718)
,p_name=>'Sub Regions'
