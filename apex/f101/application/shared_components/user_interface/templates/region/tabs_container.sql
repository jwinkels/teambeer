...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2112937881107729)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2113265164107729)
,p_plug_template_id=>wwv_flow_imp.id(2112937881107729)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2113550267107729)
,p_plug_template_id=>wwv_flow_imp.id(2112937881107729)
,p_name=>'Tabs'
